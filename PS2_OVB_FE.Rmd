...
```{r}
r10 <- felm(data=data.final, aauw ~ ngirls + female + white + repub_i + age + agesqrd + srvlng + srvlngsqrd + rel.none + rel.cath_orth + rel.othchris + rel.jew + demvote)
...
## Question 13: Explain what the region fixed effects are cwhiontrolling for?
